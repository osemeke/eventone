...
$this->title = $category;
$this->params['breadcrumbs'][] = ['label' => $group, 'url' => ['group?id=' . $group_id]];
...
<!-- main content--><div class="col-md-8 group-index">
	...
	<?php
	if ($count == 0) {
		echo "<div class=\"alert alert-info\">There are no listings found for this category!</div>";
	}

	foreach ($model as $service) {

		$imagelink = 'no-image.npg';
